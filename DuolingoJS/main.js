window.addEventListener("load", function () {
  ...
  const checkAnswer = () => {
    ...
    if (ansStr === data[incr].engPhrase) {
      //console.log('correct');
      sound = new Audio(
        "https://res.cloudinary.com/nzmai/video/upload/v1605697967/lvlupsound_n13hts.mp3"
      );
      sound.play();
      ...
      //console.log('false');
      sound = new Audio(
        "https://res.cloudinary.com/nzmai/video/upload/v1605698209/errorsound_jxtmqg.mp3"
      );
      sound.play();
      footer.style.display = "none";
  ...
  const getNewQuestion = (i) => {
    ...
    wordItems.forEach((wordItem) =>
      wordItem.addEventListener("mouseover", (e) => {
